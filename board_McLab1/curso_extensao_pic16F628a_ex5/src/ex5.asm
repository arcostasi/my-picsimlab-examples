...
#DEFINE BOTAO_DIR_RAPIDO PORTA,1 ;BOTÃO DIREITA RÁPIDO
#DEFINE BOTAO_DIR_LENTO  PORTA,2 ;BOTÃO DIREITA LENTO
#DEFINE BOTAO_ESQ_LENTO  PORTA,3 ;BOTÃO ESQUERDA LENTO
#DEFINE BOTAO_ESQ_RAPIDO PORTA,4 ;BOTÃO ESQUERDA RÁPIDO
...
BOTAO_DIR_LENTO_LIB
        BTFSC   BOTAO_DIR_LENTO          ;SE BOTAO_DIR_LENTO ESTIVER PRESSIONADO
                                         ;RETORNA PARA A ROTINA QUE A CHAMOU
        GOTO    MAIN                     ;SE NÃO, RETORNA PARA A ROTINA DE INICIO
        RETURN

BOTAO_DIR_RAPIDO_LIB
        BTFSC   BOTAO_DIR_RAPIDO         ;SE BOTAO_DIR_RAPIDO ESTIVER PRESSIONADO
                                         ;RETORNA PARA A ROTINA QUE A CHAMOU
        GOTO    MAIN                     ;SE NÃO, RETORNA PARA A ROTINA DE INICIO
        RETURN
