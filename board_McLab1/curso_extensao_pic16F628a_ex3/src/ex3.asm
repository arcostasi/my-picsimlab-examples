...
#DEFINE LED     PORTB,2        ;LED PARA CONTADOR
...
BOTAO_LIB                      ;ROTINA DO BOTÃO 1 LIBERADO
        BTFSC   BOTAO1         ;TESTA O BOTÃO PARA DETECTAR
                               ;SE O MESMO FOR LIBERADO
        GOTO    $-1            ;BOTÃO AINDA PRESSIONADO, CONTINUA TESTANDO
        GOTO    LIGA_LED       ;BOTÃO LIBERADO, VÁ PARA ROTINA LIGA LED
